...
public class MapaGui extends JFrame {
      ...
      //  this.revalidate();
        ...
        timer = new Timer(5, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                for (Enemigo i : BomberMan.enemigos) {
                    i.move();
                }
                panel.repaint();
            }
    ...
    private class TAdapter extends KeyAdapter {
        ...
        public void keyReleased(KeyEvent e) {
            ...
            if (key != KeyEvent.VK_SPACE) {
                BomberMan.jugadores.get(0).Stop();
            }
        }
        ...
        public void keyPressed(KeyEvent e) {
            ...
            switch (key) {
                case KeyEvent.VK_LEFT:
                    BomberMan.jugadores.get(0).direccion = Tipos.Movimiento.LEFT;
                    break;
                case KeyEvent.VK_RIGHT:
                    BomberMan.jugadores.get(0).direccion = Tipos.Movimiento.RIGHT;
                    break;
                case KeyEvent.VK_UP:
                    BomberMan.jugadores.get(0).direccion = Tipos.Movimiento.UP;
                    break;
                case KeyEvent.VK_DOWN:
                    BomberMan.jugadores.get(0).direccion = Tipos.Movimiento.DOWN;
                    break;
    ...
    public void panelPaint(Graphics g) {
        ...
        g.drawRect(BomberMan.jugadores.get(0).getX(), BomberMan.jugadores.get(0).getY() + Img.playerHeight - 30, Img.playerWidth, 30);
